...
function hash_int31(ip, seed) {
    let hash = ip.reduce(function (r, num) {
        r += parseInt(num, 10);
        r %= 2147483648;
        r += (r << 10)
        r %= 2147483648;
...
t1 = new Date();
for (let i = 0; i < ipsv4.length; i++) {
    let index = hash_int31((ipsv4[i] || '').split(/\./g), seed) % len;
...
t1 = new Date();
for (let i = 0; i < ipsv4.length; i++) {
    let index = hash_numeric_real(ipsv4[i]) % len;
...
t1 = new Date();
for (let i = 0; i < ipsv4.length; i++) {
    let index = hash_simple_regex(ipsv4[i]) % len;
...
t1 = new Date();
for (let i = 0; i < ipsv4.length; i++) {
    let index = hash_simple_loop(ipsv4[i]) % len;
...
t1 = new Date();
for (let i = 0; i < ipsv4.length; i++) {
    let index = farmhash.fingerprint32(ipsv4[i]) % len;
...
console.log('benchmarking int31...');
t1 = new Date();
for (let i = 0; i < ipsv6.length; i++) {
    let index = hash_int31((ipsv6[i] || '').split(/\./g), seed) % len;
    if (!scatter_int31.hasOwnProperty(index)) {
        scatter_int31[index] = 1;
    } else {
        scatter_int31[index]++;
...
t1 = new Date();
for (let i = 0; i < ipsv6.length; i++) {
    let index = hash_numeric_real(ipsv6[i]) % len;
    if (!scatter_numeric_real.hasOwnProperty(index)) {
        scatter_numeric_real[index] = 1;
    } else {
        scatter_numeric_real[index]++;
...
t1 = new Date();
for (let i = 0; i < ipsv6.length; i++) {
    let index = hash_simple_regex(ipsv6[i]) % len;
    if (!scatter_numeric_simple_regex.hasOwnProperty(index)) {
        scatter_numeric_simple_regex[index] = 1;
    } else {
        scatter_numeric_simple_regex[index]++;
...
t1 = new Date();
for (let i = 0; i < ipsv6.length; i++) {
    let index = hash_simple_loop(ipsv6[i]) % len;
    if (!scatter_numeric_simple_loop.hasOwnProperty(index)) {
        scatter_numeric_simple_loop[index] = 1;
    } else {
        scatter_numeric_simple_loop[index]++;
...
t1 = new Date();
for (let i = 0; i < ipsv6.length; i++) {
    let index = farmhash.fingerprint32(ipsv6[i]) % len;
    if (!scatter_numeric_farmhash.hasOwnProperty(index)) {
        scatter_numeric_farmhash[index] = 1;
    } else {
        scatter_numeric_farmhash[index]++;
